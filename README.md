...
The changes are:
- the `config.s3` and `config.azure_blob` values are no more supported. You how have to use the storage config as defined in the [docs](https://quickwit.io/docs/configuration/storage-config).
